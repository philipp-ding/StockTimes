...
def aktualisieren():
    ...
    for counter, symbol in enumerate(df.columns):
        ...
        else: print(f"Prediction based on new data {counter}/{len(df.columns)} Done")
    ...
    print(f"Prediction Done, saved Data in FrontendFallstudie//Data//predicted_daframe.csv")
